...
import { MessageCircle } from "lucide-react"; // make sure to install via npm
      ...
      {isOpen && (
        <div className="fixed bottom-20 right-6 w-80 h-96 bg-white rounded-xl shadow-xl p-4 flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto border p-2 rounded bg-gray-50">
            {/* TODO: Replace with Chart.js or your live chart component */}
            <p className="text-sm text-gray-500">
              This is where the live chart or chat UI will go.
            </p>
          </div>
          <input
            type="text"
